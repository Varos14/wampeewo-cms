    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="p-5 flex flex-col justify-between" variant="glass">
          <div>
            <h3 className="font-bold text-slate-800 text-sm border-b border-black/5 pb-3 mb-4">School Details</h3>
            <div className="space-y-3.5 text-xs">
              <div>
                <span className="text-slate-500 font-semibold uppercase tracking-wider block">School Name</span>
                <span className="text-slate-700 font-medium mt-0.5 block">Wampeewo Ntake Secondary School</span>
              </div>
              <div>
                <span className="text-slate-500 font-semibold uppercase tracking-wider block">Active Academic Term</span>
                <span className="text-slate-700 font-medium mt-0.5 block">Term I, 2026</span>
              </div>
              <div>
                <span className="text-slate-500 font-semibold uppercase tracking-wider block">Curriculum Model</span>
                <span className="text-slate-700 font-medium mt-0.5 block">Uganda Lower Secondary (Competence-based)</span>
              </div>
              <div>
                <span className="text-slate-500 font-semibold uppercase tracking-wider block">Grading Rubric</span>
                <span className="text-slate-700 font-medium mt-0.5 block">3-Point Competence Grid + D1-F9 Terminal Exams</span>
              </div>
            </div>
          </div>
        ...
        <Card className="p-5 flex flex-col justify-between" variant="glass">
          <div>
            <h3 className="font-bold text-slate-800 text-sm border-b border-black/5 pb-3 mb-4">Your Session Profile</h3>
            {user && (
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <img
                    ...
                    alt={user.name}
                    className="w-12 h-12 rounded-xl bg-white shrink-0 border border-black/10"
                  />
                  <div>
                ...
                <div className="space-y-3.5 text-xs">
                  ...
                  <div>
                    ...
                    <span className="text-slate-700 font-medium font-mono text-2xs truncate block">JWT Token Active</span>
                  </div>
                </div>
              </div>
            )}
        ...
        <Card className="p-5 flex flex-col justify-between" variant="glass">
          <div>
            <h3 className="font-bold text-slate-800 text-sm border-b border-black/5 pb-3 mb-4">Developer & Server Config</h3>
            <div className="space-y-3.5 text-xs">
              <div>
              ...
              <div>
                ...
                <span className="text-slate-700 font-medium font-mono mt-0.5 block">http://localhost:4000/api</span>
              </div>
              <div>
                <span className="text-slate-500 font-semibold uppercase tracking-wider block">Database Driver</span>
                <span className="text-slate-700 font-medium mt-0.5 block">MySQL2 / Pool Connection</span>
              </div>
              <div>
                <span className="text-slate-500 font-semibold uppercase tracking-wider block">App Build Target</span>
                <span className="text-slate-700 font-medium font-mono mt-0.5 block">Vite / ES2020</span>
              </div>
            </div>
          </div>
          <div className="mt-4 border-t border-black/5 pt-3">
